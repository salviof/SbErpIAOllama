...
public class E_Quando_o_usuario_envia_a_mensagem_perguntando_nome_e_idade_para_persona_joao {
    ...
    public void implementacaoEtapa() {
        ItfRespostaAcaoDoSistema resposta = ControllerIAPersonas.conversaChatComHistorico(FluxoIAOllama.PERSONA1_ADOLESCENTE, "Qual seu nome?", SBCore.getUsuarioLogado(), UtilPersona.gerarPromptSystem(FluxoIAOllama.PERSONA1_ADOLESCENTE)); // colocar o valor logico aqui
